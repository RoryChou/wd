  ...
  <div class="page show">
    <div class="page-inner">
      <div class="page-panel">
        <div class="top-menu">
          <router-link :to="{path:'/editvisitor',query:{memberId:this.memberId}}"><i class="add"></i>新增常用游玩人
          </router-link>
        </div>
        <transition name="fade">
          <div class="infos" v-show="!loadingData">
            ...
            <info-box v-else v-for="visitor in visitorInfos" :key="visitor.visitorId" :model="visitor"
                      @delete="handleDeleteVisitor" @edit="handleEditVisitor"/>
          </div>
        </transition>
      </div>
    </div>
